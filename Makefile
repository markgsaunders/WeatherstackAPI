...
# Enable Wi-Fi by choosing the RTOS, TCP/IP stack and Mbed TLS
COMPONENTS+=FREERTOS
COMPONENTS+=LWIP
COMPONENTS+=MBEDTLS

# Select the combo device on the kit
...
# If you are using the CY8CKIT-028-TFT shield un-comment the following line
